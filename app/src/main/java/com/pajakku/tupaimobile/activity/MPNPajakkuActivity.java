...
public class MPNPajakkuActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mpn_pajakku);
...
//        appActionBar.setTypeNoShadow();
        ...
        ProgressBar progressBar = findViewById(R.id.mpnpajakku_progressbar);

        webView = findViewById(R.id.mpnpajakku_webview);
...
//        webView.loadUrl( "file:///android_asset/communication_test.html" );
    ...
    public void backWithValue(String url){
        // app://com.pajakku.tupaimobile?institutionCode=77777&vaNo=2254058450&xp1=35
        Map<String,String> map = Utility.urltoMapQueryParam(url);

        ActRtnMpnPajakku actRtn = new ActRtnMpnPajakku();
        actRtn.sspIdSet( map.get(DeepLinkHandlerActivity.DEEPLINK_PARAM_SSPID) );
        actRtn.institutionCode = map.get(DeepLinkHandlerActivity.DEEPLINK_PARAM_INSTITUTION);
        actRtn.vaNumber = map.get(DeepLinkHandlerActivity.DEEPLINK_PARAM_VA);
...
//
    ...
    public static void startAct(Activity act, String url, int reqCode, AppStatusData appStatusData){
        ...
        Intent itn = new Intent(act, MPNPajakkuActivity.class);
