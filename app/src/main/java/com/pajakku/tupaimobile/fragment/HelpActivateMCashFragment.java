 ...
 */
public class HelpActivateMCashFragment extends Fragment {
    public static final int VIEW_PAGER_CODE = 3;


//    private OnFragmentInteractionListener mListener;

    public HelpActivateMCashFragment() {
...
//        }
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_help_activatemcash, container, false);

        final NonSwipeableViewPager viewPager = getActivity().findViewById(R.id.fraghelp_pager);

        AppActionBar actionBar = view.findViewById(R.id.helpactivatemcash_appactionbar);
