...
public interface ApiCallBilling {

        @Deprecated
        String getKjs_kjpId = "kjpId";
        @Deprecated
        @GET(AppConstant.EBILLING_INTERNAL_PREFIXURL+"kjs/kjpId/{"+getKjs_kjpId+"}")
        Call<List<RespKjs>> getKjs(@Header(AppConstant.HEADER_AUTHORIZATION) String auth, @Path(getKjs_kjpId) String kjpId);
        //
