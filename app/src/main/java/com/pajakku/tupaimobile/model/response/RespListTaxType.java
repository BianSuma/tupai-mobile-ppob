package com.pajakku.tupaimobile.model.response;
...
public class RespListTaxType implements Serializable {  // KAP
    public static final String TABLE_NAME = "taxType";
    ...
    public Taxtype toTaxType(long idLong){
    ...
    public static List<Taxtype> toTaxType(List<RespListTaxType> l){
        List<Taxtype> ll = new ArrayList<>();
        long j = 1;
        for(RespListTaxType i : l) ll.add(i.toTaxType(j++));
        return ll;
    }
